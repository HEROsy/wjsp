            ...
            <div class="row-fluid">
                ...
                <div class="span8">
                    <div class="row-fluid" style="height: 30px;">
                        <span style="display:block;text-align:right;line-height:30px;color:#68C3FF; margin-right: 20px;float:right">系统开发：雅安十网科技开发有限公司</span>
                        <span id="amsg"></span>
                    </div>
...
<%--                            <div class="xiala2" onclick="document.getElementById('center').src='OA_zdylcfb.aspx'"><span>自定义流程发布</span><span class="jiantou1">●</span></div>--%>
                            <div class="xiala2" onclick="document.getElementById('center').src='OA_dxfb.aspx'"><span>定向发布</span><span class="jiantou1">●</span></div>
                            </div>
                        </div>

...
public class _BLL
{
    ...
    public int Addspll(string userid, string contents, string splname, string contents_txt)
    {
        ...
        SqlParameter[] spr ={new SqlParameter("@u_id",userid),
                         new SqlParameter("@spl_content",contents),
                      new SqlParameter("@spl_name", splname),
                           new SqlParameter("@spl_content_txt", contents_txt)};
    ...
    public DataTable Json_spl(string sender_id,String type)
    {
        String tablename = "";
        if (type.Equals("ing"))
        {
        ...
        SqlParameter[] spr = { 
                                ...
                                new SqlParameter("@splc_datas", sender_id)
                            
                             };

        String sql = "select id,titles,next_id from "+tablename+" where sender_id=@sender_id or splc_datas like '%"+sender_id+"%'"; //SqlHelper.GetSQLSelect_normal("", "id,titles", "oa_dq_spl", spr, "=,like", "or", "id desc");
    ...
    public DataTable GetNewMessageCount(String userid)
    {
        DataTable dt = null;

        String sql = "select id from oa_dq_spl where next_id like '%" + userid + "%'";
        dt = SqlHelper.GetTable(sql, CommandType.Text, null);
        return dt;
    }
    ...
    */
  ...
  
    {
        ...
        String sql = SqlHelper.GetSQLSelect_normal("", "titles,sender_times,contents,spl_huizhi,splc_datas,fj_url,spyj_id_contents_times,next_id,spl_type", "oa_dq_spl", spr, "=", "", "id desc");
    ...
    public DataTable Oa_ls_spl(string id)
    {
        ...
        String sql = SqlHelper.GetSQLSelect_normal("", "titles,sender_times,contents,spl_huizhi,splc_datas,fj_url,spyj_id_contents_times,next_id,spl_type", "oa_ls_spl", spr, "=", "", "id desc");

        ...
        function GetDataAndTonji()
        {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    document.getElementById("t2").innerHTML = zt; 
                    document.getElementById("t3").innerHTML = bj; 
                    document.getElementById("t4").innerHTML = sj; 
                    document.getElementById("t5").innerHTML = kg; 
                    document.getElementById("t6").innerHTML = zc;
